...
A write-up on the background of the development of `CBTF` is available in
[this post on the REPLAY website](https://replay.geog.uni-heidelberg.de/REPLAY-website/post/2025/08/fuzzing-luminescence-to-improve-it/).
